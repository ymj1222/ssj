						...
						<div class="col-md-12">
							<div class="panel">
								...
								<div class="panel-body">
									<form action="/ssj/ProductUpdate" method="post">
										<input type="text" class="form-control" placeholder="商品名稱"
											name="name" value="${name}" required="required"> <br>
										<select id="agentCode" name="agent.id" class="form-control"
											required="required"></select><br> <select id="type"
											name="producttype.name" class="form-control" required="required">
										</select> <br> <input type="text" class="form-control"
											placeholder="入庫數量" name="amount" value="${amount}"
											required="required" onkeyup="this.value=this.value.replace(/[^\d]/g,'');"> <br /> <select id="brand"
											name="brand.name" class="form-control"></select><br /> <input
											type="text" class="form-control" placeholder="如是衣服填尺寸"
											name="size" value="${size}"> <br> <input
											type="text" class="form-control" placeholder="顏色"
											name="color" value="${color}"> <br> <input
											type="text" class="form-control" placeholder="銷售價"
											name="sellValue" value="${sell}" required="required" onkeyup="clearNoNum(this)">
										<br> <input type="text" class="form-control"
											placeholder="市場價" name="marketValue" value="${market}"
											required="required" onkeyup="clearNoNum(this)"> <br> <input type="hidden"
											name="code" value="${code}"> <input type="text"
											class="form-control" placeholder="介紹" name="induction"
											required="required">
