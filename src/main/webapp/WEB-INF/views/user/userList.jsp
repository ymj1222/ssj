                ...
                $.each(datas.list,
                    function(i, obj) {
                        ...
                        cont = cont + '<td>' + obj.name
                            + '</td>';
                        cont += '<td><a href=javascript:del("' + obj.name
                            + '"); title="删除">删除</a>  ';
                        cont += '<a href="userUpdate?id=' + obj.id
                            + '">修改</a></td>';
                        cont = cont + '</tr>';
                    });
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="navbar-form navbar-left">
                                    <a href="finduserAdd" class=""><button type="button">user新增</button></a>
                                </div>
                                <div class="navbar-form navbar-left">
                                    <input type="text" maxlength="10" name="accm" id="accmId" class="input-text"
                                           placeholder="姓名">
