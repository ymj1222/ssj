				...
				$.ajax({
					...
					success : function(datas){ //function为一个回调函数，data表示为请求servlet后，servlet中返回回来的值
						...
						$.each(datas.list,function(i,obj){
							...
							cont+='<td><a href="logisticsDelete?code='+obj.code+'" title="删除">删除</a></td>';	
							cont = cont +'</tr>';							
						});
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-body">
									<i class="lnr lnr-pencil" class="btn btn-primary"><a href="findlogisticsAdd">添加物流公司</a></i>
