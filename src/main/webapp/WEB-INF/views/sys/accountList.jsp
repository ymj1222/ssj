										...
										function(i, obj) {
											...
											if (obj.state == "0") {
												cont += '<td><a href=javascript:del("'
														+ obj.code
														+ '",1); title="失效">失效</a>&nbsp;&nbsp;<a href="toAccountUpdate?account='
														+ obj.account
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-body">
										<i class="lnr lnr-pencil" class="btn btn-primary"><a href="toAccountAdd1">添加超管</a></i>
